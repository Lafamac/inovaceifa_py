...
export const Header = () => {
  ...
  // Efeito para sincronizar classe dark no HTML
  useEffect(() => {
    if (darkMode) {
  ...
  // Efeito para escutar cliques fora dos dropdowns
  useEffect(() => {
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200/60 bg-slate-50 hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-950 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-all focus:outline-none"
              title="Alternar Tema"
            >
              {darkMode ? (
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-1.5 w-52 rounded-xl border border-slate-200/60 bg-white p-1.5 shadow-xl dark:border-slate-800 dark:bg-slate-900 animate-in fade-in slide-in-from-top-2 duration-150">
                  ...
                  <button
                    ...
                    className="flex w-full items-center space-x-2.5 rounded-lg px-2.5 py-1.5 text-left text-xs font-medium text-slate-600 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800 transition-colors"
                  >
                  ...
                  <button
                    onClick={() => console.log("Logout simulation")}
                    className="flex w-full items-center space-x-2.5 rounded-lg px-2.5 py-1.5 text-left text-xs font-medium text-rose-600 hover:bg-rose-50 dark:text-rose-400 dark:hover:bg-rose-950/20 transition-colors"
                  >
