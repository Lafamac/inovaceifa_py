...
- [x] Corrigido bug em que a seleção do planejamento sumia ao clicar ou atualizar a lista, adicionando destaque adaptável e responsivo aos cards selecionados/não selecionados na coluna esquerda, e renomeando "Adicionar OS" para "Adicionar Atividade" com maior destaque visual.
