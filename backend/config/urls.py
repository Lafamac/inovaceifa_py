...
from accounts.views import me, CustomTokenObtainPairView, alterar_senha, recuperar_senha
...
urlpatterns = [
    ...
    path('api/auth/recuperar-senha/', recuperar_senha, name='auth_recuperar_senha'),
